...
public class AbiZswSerializationProviderImpl implements ISerializationProvider {

    static {
        if (!EmbeddedLibraryTools.LOADED_EMBEDDED_LIBRARY)
            System.loadLibrary("zswjavaabieos");
    }
    ...
    private String TAG = "AbiZswSerializationProviderImpl";
    ...
    /**
     * Create a new AbiZswSerializationProviderImpl serialization provider instance, initilizing a new context for the C++
     * library to work on automatically.
     *
     * @throws SerializationProviderError - An error is thrown if the context cannot be created.
     */
    public AbiZswSerializationProviderImpl() throws SerializationProviderError {
        context = create();
        if (null == context) {
     ...
     * This method should always be called before letting the AbiZswSerializationProviderImpl instance go out of scope
     ...
     * conversions to be done using the same AbiZswSerializationProviderImpl instance.
